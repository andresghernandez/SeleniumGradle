...
public class RegistroUsuarioStepsDefinition {
	...
	public void queEstoyEnLaPaginaDeRegistro(int row, DataTable dataExcel){
		...
		//Para traer los datos usuario y contraseña escritos en el feature
		//RegisterStep.iniciarSesionRegistrado(dataFeature.get(0).get("Usuario"), dataFeature.get(0).get("Contraseña"));
