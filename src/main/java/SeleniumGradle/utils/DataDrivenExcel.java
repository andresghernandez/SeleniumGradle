...
public class DataDrivenExcel {
	...
	public Map<String, String> leerExcel(Excel excel) {
		...
		try {
			FileInputStream arcExcel = new FileInputStream(new File(excel.getRutaExcel())); 			// Invocación y uso del excel
			...
			while (iterator.hasNext()) { 			// Ciclo de iteración por cada fila
